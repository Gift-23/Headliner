...
var apiDefaultCountry = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiDefaultCountry;
...
var NewsService = /** @class */ (function () {
    function NewsService(http) {
        this.http = http;
        this.country = apiDefaultCountry;
        this.headlinePage = 0;
        this.categoryPage = 0;
    }
    NewsService.prototype.exec = function (query) {
        query = apiUrl + query;
        return this.http.get(query, { headers: headers });
    };
    NewsService.prototype.getTopHeadline = function () {
        this.headlinePage++;
        return this.exec("/top-headlines?country=" + this.country + "&category=business&page=" + this.headlinePage);
    };
    NewsService.prototype.getTopHeadlineWithCategory = function (cat) {
        if (this.categorySelected === cat)
            this.categoryPage++;
        else {
            this.categoryPage = 1;
            this.categorySelected = cat;
        }
        return this.exec("/top-headlines?country=" + this.country + "&category=" + cat + "&page=" + this.categoryPage);
    };
